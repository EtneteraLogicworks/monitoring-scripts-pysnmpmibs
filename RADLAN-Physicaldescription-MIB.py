...
# ASN.1 source file:///Users/michal/.snmp/mibs/RADLAN-Physicaldescription-MIB
...
rndErrorSeverity, rnd, rndErrorDesc, rndNotifications = mibBuilder.importSymbols("RADLAN-MIB", "rndErrorSeverity", "rnd", "rndErrorDesc", "rndNotifications")
ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup")
MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, MibIdentifier, ModuleIdentity, ObjectIdentity, Counter32, NotificationType, Unsigned32, Integer32, Counter64, IpAddress, Bits, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Counter32", "NotificationType", "Unsigned32", "Integer32", "Counter64", "IpAddress", "Bits", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("RADLAN-Physicaldescription-MIB", rlPhdUnitGenParamAssetTag=rlPhdUnitGenParamAssetTag, rlPhdStackUnit=rlPhdStackUnit, rlPhdPortsColumn=rlPhdPortsColumn, rlPhdUnitEnvParamTable=rlPhdUnitEnvParamTable, rlPhdUnitGenParamStackUnit=rlPhdUnitGenParamStackUnit, rlPhdPortsIfIndex=rlPhdPortsIfIndex, rlPhdUnitGenParamEntry=rlPhdUnitGenParamEntry, PYSNMP_MODULE_ID=rlPhysicalDescription, rlCascadeIfIndexAfterReset=rlCascadeIfIndexAfterReset, rlPhdPoePresent=rlPhdPoePresent, rlCascadeTrunkIdAfterReset=rlCascadeTrunkIdAfterReset, rlPhdNumberOfPoeUnits=rlPhdNumberOfPoeUnits, rlPhdModuleRow=rlPhdModuleRow, rlCascadeEntry=rlCascadeEntry, rlPhdPoeStackUnit=rlPhdPoeStackUnit, rlPhdConnectorType=rlPhdConnectorType, rlPhdModuleEntry=rlPhdModuleEntry, rlCascadeAfterResetEntry=rlCascadeAfterResetEntry, rlPhdPortsIfIndexName=rlPhdPortsIfIndexName, rlPhdStackOrderTopUnit=rlPhdStackOrderTopUnit, rlPhdUnitEnvParamUpTime=rlPhdUnitEnvParamUpTime, rlPhdPortsStackUnit=rlPhdPortsStackUnit, rlPhdModuleStartingPort=rlPhdModuleStartingPort, rlPhdUnitGenParamSoftwareVersion=rlPhdUnitGenParamSoftwareVersion, rlPhdUnitGenParamServiceTag=rlPhdUnitGenParamServiceTag, rlPhdStackOrderBottomUnit=rlPhdStackOrderBottomUnit, rlStackDuplicateUnitNotJoin=rlStackDuplicateUnitNotJoin, rlPhdPhyLedStackUnit=rlPhdPhyLedStackUnit, rlPhdModuleHotSwapAdminStatus=rlPhdModuleHotSwapAdminStatus, rlPhdStackFixedUnit=rlPhdStackFixedUnit, rlPhdStackOrderTable=rlPhdStackOrderTable, rlPhdModuleColumn=rlPhdModuleColumn, rlPhdUnitGenParamHardwareVersion=rlPhdUnitGenParamHardwareVersion, rlStackMasterSwitchover=rlStackMasterSwitchover, rlPhdUnitEnvParamTempSensorStatus=rlPhdUnitEnvParamTempSensorStatus, rlPhdUnitEnvParamFan3Status=rlPhdUnitEnvParamFan3Status, rlPhdStackOrderDesiredUnitPosition=rlPhdStackOrderDesiredUnitPosition, rlPhdUnitEnvParamMainPSStatus=rlPhdUnitEnvParamMainPSStatus, rlPhdStackOrderEntry=rlPhdStackOrderEntry, rlPhdUnitEnvParamFan4Status=rlPhdUnitEnvParamFan4Status, rlCascadeTable=rlCascadeTable, rlPhdStackOrderCurrentUnitPosition=rlPhdStackOrderCurrentUnitPosition, rlPhdStackProductID=rlPhdStackProductID, rlPhdStackTable=rlPhdStackTable, rlPhysicalDescription=rlPhysicalDescription, rlPhdModuleIndex=rlPhdModuleIndex, rlPhdPoeEntry=rlPhdPoeEntry, rlPhdStackOrderUnitIndex=rlPhdStackOrderUnitIndex, rlPhdModuleRole=rlPhdModuleRole, rlPhdModuleHotSwapOperStatus=rlPhdModuleHotSwapOperStatus, rlCascadeTrunkId=rlCascadeTrunkId, rlPhdStackReorder=rlPhdStackReorder, rlPhdUnitEnvParamRedundantPSStatus=rlPhdUnitEnvParamRedundantPSStatus, rlStackUnitRemoved=rlStackUnitRemoved, rlPhdStackOrderUnitType=rlPhdStackOrderUnitType, rlPhdPhyLedTimeout=rlPhdPhyLedTimeout, rlPhdNumberOfUnits=rlPhdNumberOfUnits, rlPhdPortsEntry=rlPhdPortsEntry, rlPhdPortsTable=rlPhdPortsTable, rlPhdPortsModuleNumber=rlPhdPortsModuleNumber, rlPhdStackType=rlPhdStackType, rlPhdPortsMediaType=rlPhdPortsMediaType, rlPhdPortHaul=rlPhdPortHaul, rlPhdUnitGenParamSerialNum=rlPhdUnitGenParamSerialNum, rlPhdUnitGenParamFirmwareVersion=rlPhdUnitGenParamFirmwareVersion, rlCascadeNeighborIfIndex=rlCascadeNeighborIfIndex, rlPhdUnitEnvParamTempSensorValue=rlPhdUnitEnvParamTempSensorValue, rlPhdUnitEnvParamFan2Status=rlPhdUnitEnvParamFan2Status, rlPhdMibVersion=rlPhdMibVersion, rlPhdStackFixedUnitLocation=rlPhdStackFixedUnitLocation, rlPhdUnitEnvParamEntry=rlPhdUnitEnvParamEntry, rlPhdUnitEnvParamStackUnit=rlPhdUnitEnvParamStackUnit, rlPhdUnitGenParamTable=rlPhdUnitGenParamTable, rlCascadeAfterResetTable=rlCascadeAfterResetTable, rlPhdPortsRow=rlPhdPortsRow, rlPhdStackConnect2=rlPhdStackConnect2, rlPhdModuleHotSwapTable=rlPhdModuleHotSwapTable, rlStackBackupUnitRemoved=rlStackBackupUnitRemoved, rlPhdStackSofrwareVer=rlPhdStackSofrwareVer, rlPhdStackReloadUnit=rlPhdStackReloadUnit, rlPhdStackEntry=rlPhdStackEntry, rlPhdModuleStackUnit=rlPhdModuleStackUnit, rlPhdStackOrderPermutation=rlPhdStackOrderPermutation, rlCascadeRowStatus=rlCascadeRowStatus, rlStackLinkChange=rlStackLinkChange, rlPhdMaxNumberOfUnits=rlPhdMaxNumberOfUnits, rlStackConfigChangedRingChain=rlStackConfigChangedRingChain, rlPhdModuleType=rlPhdModuleType, rlPhdStackConnect1=rlPhdStackConnect1, rlPhdUnitEnvParamFan1Status=rlPhdUnitEnvParamFan1Status, rlPhdModuleHotSwapEntry=rlPhdModuleHotSwapEntry, rlPhdModuleTable=rlPhdModuleTable, rlPhdPoeTable=rlPhdPoeTable, rlPhdForceMasterUnit=rlPhdForceMasterUnit, rlCascadeNeighborUnit=rlCascadeNeighborUnit, rlPhdModuleNumberOfPorts=rlPhdModuleNumberOfPorts, rlStackUnitDifferentSwVersion=rlStackUnitDifferentSwVersion, rlPhdStackMacAddr=rlPhdStackMacAddr, rlPhdUnitEnvParamFan5Status=rlPhdUnitEnvParamFan5Status)
