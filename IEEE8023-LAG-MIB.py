...
# ASN.1 source file:///Users/michal/.snmp/mibs/IEEE8023-LAG-MIB
# Produced by pysmi-0.3.4 at Mon Jun 22 15:10:44 2020
...
iso, ModuleIdentity, TimeTicks, NotificationType, Gauge32, MibIdentifier, Integer32, ObjectIdentity, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "TimeTicks", "NotificationType", "Gauge32", "MibIdentifier", "Integer32", "ObjectIdentity", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "Bits")
...
ieee802dot3 = MibIdentifier((1, 2, 840, 10006))
snmpmibs = MibIdentifier((1, 2, 840, 10006, 300))
...
dot3adAggPortSelectedAggID = MibTableColumn((1, 2, 840, 10006, 300, 43, 1, 2, 1, 1, 12), InterfaceIndexOrZero()).setMaxAccess("readonly")
if mibBuilder.loadTexts: dot3adAggPortSelectedAggID.setStatus('current')
dot3adAggPortAttachedAggID = MibTableColumn((1, 2, 840, 10006, 300, 43, 1, 2, 1, 1, 13), InterfaceIndexOrZero()).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("IEEE8023-LAG-MIB", dot3adAggPortStatsMarkerResponsePDUsTx=dot3adAggPortStatsMarkerResponsePDUsTx, dot3adAggAggregateOrIndividual=dot3adAggAggregateOrIndividual, dot3adAggPortStatsMarkerResponsePDUsRx=dot3adAggPortStatsMarkerResponsePDUsRx, member_body=member_body, dot3adAggPortPartnerAdminPortPriority=dot3adAggPortPartnerAdminPortPriority, PortList=PortList, dot3adAggPortPartnerAdminState=dot3adAggPortPartnerAdminState, dot3adAggPortAttachedAggID=dot3adAggPortAttachedAggID, dot3adAggActorOperKey=dot3adAggActorOperKey, dot3adAggPortPartnerAdminSystemID=dot3adAggPortPartnerAdminSystemID, dot3adAggPortDebugActorSyncTransitionCount=dot3adAggPortDebugActorSyncTransitionCount, dot3adAggPortDebugPartnerChurnState=dot3adAggPortDebugPartnerChurnState, dot3adAggPortEntry=dot3adAggPortEntry, dot3adAggGroup=dot3adAggGroup, dot3adAggPortListEntry=dot3adAggPortListEntry, dot3adAggPortActorPort=dot3adAggPortActorPort, dot3adAggPortIndex=dot3adAggPortIndex, dot3adAggPortActorAdminState=dot3adAggPortActorAdminState, dot3adAggPortDebugActorChangeCount=dot3adAggPortDebugActorChangeCount, dot3adAggPortPartnerOperPortPriority=dot3adAggPortPartnerOperPortPriority, dot3adAggPortActorAdminKey=dot3adAggPortActorAdminKey, dot3adAggPortPartnerOperSystemPriority=dot3adAggPortPartnerOperSystemPriority, ChurnState=ChurnState, dot3adAggActorAdminKey=dot3adAggActorAdminKey, dot3adAggPortPartnerOperKey=dot3adAggPortPartnerOperKey, dot3adAggConformance=dot3adAggConformance, dot3adAggPortDebugMuxState=dot3adAggPortDebugMuxState, dot3adAggPortStatsMarkerPDUsRx=dot3adAggPortStatsMarkerPDUsRx, snmpmibs=snmpmibs, dot3adAggPortDebugMuxReason=dot3adAggPortDebugMuxReason, dot3adAggPortActorOperState=dot3adAggPortActorOperState, dot3adAggCompliance=dot3adAggCompliance, dot3adAggPortTable=dot3adAggPortTable, dot3adAggGroups=dot3adAggGroups, dot3adAggPartnerOperKey=dot3adAggPartnerOperKey, us=us, dot3adAggPort=dot3adAggPort, dot3adAggPortPartnerAdminSystemPriority=dot3adAggPortPartnerAdminSystemPriority, dot3adAggPortGroup=dot3adAggPortGroup, dot3adAggPortDebugPartnerChurnCount=dot3adAggPortDebugPartnerChurnCount, dot3adAggPortDebugGroup=dot3adAggPortDebugGroup, dot3adAggPortActorSystemPriority=dot3adAggPortActorSystemPriority, dot3adAggActorSystemID=dot3adAggActorSystemID, dot3adAggPartnerSystemPriority=dot3adAggPartnerSystemPriority, dot3adAggPortDebugActorChurnState=dot3adAggPortDebugActorChurnState, PYSNMP_MODULE_ID=lagMIB, dot3adAggPortStatsMarkerPDUsTx=dot3adAggPortStatsMarkerPDUsTx, dot3adAggPortDebugRxState=dot3adAggPortDebugRxState, dot3adAggPortListPorts=dot3adAggPortListPorts, lagMIB=lagMIB, dot3adAggPortStatsTable=dot3adAggPortStatsTable, dot3adAggPortDebugPartnerSyncTransitionCount=dot3adAggPortDebugPartnerSyncTransitionCount, dot3adAggActorSystemPriority=dot3adAggActorSystemPriority, LacpState=LacpState, dot3adAgg=dot3adAgg, dot3adAggPortStatsIllegalRx=dot3adAggPortStatsIllegalRx, dot3adAggTable=dot3adAggTable, dot3adAggPortStatsLACPDUsTx=dot3adAggPortStatsLACPDUsTx, dot3adAggPortAggregateOrIndividual=dot3adAggPortAggregateOrIndividual, dot3adTablesLastChanged=dot3adTablesLastChanged, dot3adAggPortPartnerAdminPort=dot3adAggPortPartnerAdminPort, dot3adAggPortStatsEntry=dot3adAggPortStatsEntry, dot3adAggPortPartnerAdminKey=dot3adAggPortPartnerAdminKey, dot3adAggEntry=dot3adAggEntry, dot3adAggPortStatsUnknownRx=dot3adAggPortStatsUnknownRx, dot3adTablesLastChangedGroup=dot3adTablesLastChangedGroup, dot3adAggMACAddress=dot3adAggMACAddress, dot3adAggPortListTable=dot3adAggPortListTable, dot3adAggPortDebugLastRxTime=dot3adAggPortDebugLastRxTime, dot3adAggPortDebugEntry=dot3adAggPortDebugEntry, dot3adAggPortDebugPartnerChangeCount=dot3adAggPortDebugPartnerChangeCount, LacpKey=LacpKey, dot3adAggPortListGroup=dot3adAggPortListGroup, dot3adAggPortStatsGroup=dot3adAggPortStatsGroup, dot3adAggPortActorSystemID=dot3adAggPortActorSystemID, dot3adAggCollectorMaxDelay=dot3adAggCollectorMaxDelay, dot3adAggPortStatsLACPDUsRx=dot3adAggPortStatsLACPDUsRx, dot3adAggPortDebugTable=dot3adAggPortDebugTable, lagMIBObjects=lagMIBObjects, dot3adAggCompliances=dot3adAggCompliances, dot3adAggPortPartnerOperSystemID=dot3adAggPortPartnerOperSystemID, dot3adAggPortSelectedAggID=dot3adAggPortSelectedAggID, ieee802dot3=ieee802dot3, dot3adAggPortActorOperKey=dot3adAggPortActorOperKey, dot3adAggPortActorPortPriority=dot3adAggPortActorPortPriority, dot3adAggPortPartnerOperState=dot3adAggPortPartnerOperState, dot3adAggPortPartnerOperPort=dot3adAggPortPartnerOperPort, dot3adAggPortDebugActorChurnCount=dot3adAggPortDebugActorChurnCount, dot3adAggPartnerSystemID=dot3adAggPartnerSystemID, dot3adAggIndex=dot3adAggIndex)
