...
# ASN.1 source file:///Users/michal/.snmp/mibs/SYNOLOGY-DISK-MIB
...
mibBuilder.exportSymbols("SYNOLOGY-DISK-MIB", diskModel=diskModel, diskCompliance=diskCompliance, diskStatus=diskStatus, synoDisk=synoDisk, diskIndex=diskIndex, diskType=diskType, diskCompliances=diskCompliances, diskGroup=diskGroup, PYSNMP_MODULE_ID=synoDisk, synology=synology, diskTable=diskTable, diskConformance=diskConformance, diskEntry=diskEntry, diskTemperature=diskTemperature, diskID=diskID, diskGroups=diskGroups)
