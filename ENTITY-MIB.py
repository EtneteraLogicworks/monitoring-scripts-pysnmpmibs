...
mib_2, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, iso, ModuleIdentity, TimeTicks, ObjectIdentity, Integer32, Gauge32, NotificationType, MibIdentifier, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "iso", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "Integer32", "Gauge32", "NotificationType", "MibIdentifier", "Bits", "IpAddress")
TDomain, DisplayString, TimeStamp, RowPointer, TAddress, TextualConvention, TruthValue, AutonomousType, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TDomain", "DisplayString", "TimeStamp", "RowPointer", "TAddress", "TextualConvention", "TruthValue", "AutonomousType", "DateAndTime")
...
mibBuilder.exportSymbols("ENTITY-MIB", entAliasMappingTable=entAliasMappingTable, entLastChangeTime=entLastChangeTime, entLogicalType=entLogicalType, entPhysicalMfgName=entPhysicalMfgName, entityLogical=entityLogical, entPhysicalSerialNum=entPhysicalSerialNum, entLogicalTDomain=entLogicalTDomain, entPhysicalEntry=entPhysicalEntry, entAliasLogicalIndexOrZero=entAliasLogicalIndexOrZero, entity3Compliance=entity3Compliance, entityNotificationsGroup=entityNotificationsGroup, entLogicalTAddress=entLogicalTAddress, entityGeneral=entityGeneral, entityMIBObjects=entityMIBObjects, entPhysicalMfgDate=entPhysicalMfgDate, entityCompliance=entityCompliance, entityPhysical2Group=entityPhysical2Group, entityGeneralGroup=entityGeneralGroup, entityPhysical=entityPhysical, entPhysicalClass=entPhysicalClass, entityMIB=entityMIB, entPhysicalFirmwareRev=entPhysicalFirmwareRev, entityConformance=entityConformance, entLogicalContextName=entLogicalContextName, PhysicalClass=PhysicalClass, entityPhysicalGroup=entityPhysicalGroup, entLogicalTable=entLogicalTable, entPhysicalContainsEntry=entPhysicalContainsEntry, entPhysicalVendorType=entPhysicalVendorType, PhysicalIndex=PhysicalIndex, entPhysicalAssetID=entPhysicalAssetID, entLogicalIndex=entLogicalIndex, entPhysicalSoftwareRev=entPhysicalSoftwareRev, entPhysicalAlias=entPhysicalAlias, entLPPhysicalIndex=entLPPhysicalIndex, entPhysicalChildIndex=entPhysicalChildIndex, entityGroups=entityGroups, entityMapping=entityMapping, entPhysicalIndex=entPhysicalIndex, entPhysicalUris=entPhysicalUris, entPhysicalContainsTable=entPhysicalContainsTable, entityLogicalGroup=entityLogicalGroup, entityCompliances=entityCompliances, entity2Compliance=entity2Compliance, entPhysicalModelName=entPhysicalModelName, entPhysicalTable=entPhysicalTable, entPhysicalDescr=entPhysicalDescr, PhysicalIndexOrZero=PhysicalIndexOrZero, entPhysicalParentRelPos=entPhysicalParentRelPos, entPhysicalName=entPhysicalName, entAliasMappingIdentifier=entAliasMappingIdentifier, entityPhysical3Group=entityPhysical3Group, entityMIBTraps=entityMIBTraps, entPhysicalContainedIn=entPhysicalContainedIn, PYSNMP_MODULE_ID=entityMIB, SnmpEngineIdOrNone=SnmpEngineIdOrNone, entLPMappingTable=entLPMappingTable, entityMIBTrapPrefix=entityMIBTrapPrefix, entConfigChange=entConfigChange, entLogicalEntry=entLogicalEntry, entLogicalDescr=entLogicalDescr, entLogicalCommunity=entLogicalCommunity, entLPMappingEntry=entLPMappingEntry, entPhysicalHardwareRev=entPhysicalHardwareRev, entLogicalContextEngineID=entLogicalContextEngineID, entAliasMappingEntry=entAliasMappingEntry, entityLogical2Group=entityLogical2Group, entityMappingGroup=entityMappingGroup, entPhysicalIsFRU=entPhysicalIsFRU)
