...
# ASN.1 source file:///Users/michal/.snmp/mibs/SYNOLOGY-UPS-MIB
# Produced by pysmi-0.3.4 at Mon Apr 20 10:03:37 2020
...
Gauge32, NotificationType, Unsigned32, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, MibIdentifier, IpAddress, ModuleIdentity, TimeTicks, Bits, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Unsigned32", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "MibIdentifier", "IpAddress", "ModuleIdentity", "TimeTicks", "Bits", "enterprises", "iso")
...
mibBuilder.exportSymbols("SYNOLOGY-UPS-MIB", upsBatteryVoltage=upsBatteryVoltage, upsInfoPower=upsInfoPower, upsInfoDelayShutdown=upsInfoDelayShutdown, upsInfoTestResult=upsInfoTestResult, upsInfoRealPowerValue=upsInfoRealPowerValue, upsBatteryChargeRestart=upsBatteryChargeRestart, upsAmbientTemperatureMax=upsAmbientTemperatureMax, upsInfoDelay=upsInfoDelay, upsOutputVoltageValue=upsOutputVoltageValue, upsDeviceSerial=upsDeviceSerial, upsBatteryMfrDate=upsBatteryMfrDate, upsInfoTimer=upsInfoTimer, synoUPS=synoUPS, upsInputTransferReason=upsInputTransferReason, upsBatteryVoltageLow=upsBatteryVoltageLow, upsInfoLoadHigh=upsInfoLoadHigh, upsInput=upsInput, upsInfoEffciency=upsInfoEffciency, upsInfoTest=upsInfoTest, upsInputTransferLowMax=upsInputTransferLowMax, upsInfoDisplayLanguage=upsInfoDisplayLanguage, upsInfoModel=upsInfoModel, upsOutput=upsOutput, upsInfoLoadValue=upsInfoLoadValue, upsBatteryAlarmThreshold=upsBatteryAlarmThreshold, upsBatteryChargeValue=upsBatteryChargeValue, upsInputTransferBoostLow=upsInputTransferBoostLow, upsBattery=upsBattery, upsInfoTimerShutdown=upsInfoTimerShutdown, upsInputTransferTrimHigh=upsInputTransferTrimHigh, upsConformance=upsConformance, PYSNMP_MODULE_ID=synoUPS, upsInfoStartAuto=upsInfoStartAuto, upsBatteryChargeWarning=upsBatteryChargeWarning, upsDeviceContact=upsDeviceContact, upsInputVoltageExtend=upsInputVoltageExtend, upsDriverVersionData=upsDriverVersionData, upsInfoTemperature=upsInfoTemperature, upsServerVersion=upsServerVersion, upsAmbientTemperatureValue=upsAmbientTemperatureValue, upsDeviceManufacturer=upsDeviceManufacturer, upsInfoType=upsInfoType, upsInputTransferTrimLow=upsInputTransferTrimLow, upsBatteryType=upsBatteryType, upsBatteryVoltageValue=upsBatteryVoltageValue, upsDriverPollInterval=upsDriverPollInterval, upsInputVoltageValue=upsInputVoltageValue, upsInfoTestInterval=upsInfoTestInterval, synology=synology, upsInputQuality=upsInputQuality, upsInputTransferLowMin=upsInputTransferLowMin, upsInfoTime=upsInfoTime, upsInputTransferHighMin=upsInputTransferHighMin, upsInfoRealPowerNominal=upsInfoRealPowerNominal, upsInfoWatchdogStatus=upsInfoWatchdogStatus, upsDriverVersionInternal=upsDriverVersionInternal, upsInputVoltage=upsInputVoltage, upsDevice=upsDevice, upsDeviceType=upsDeviceType, upsOutputCurrentValue=upsOutputCurrentValue, upsInputCurrent=upsInputCurrent, upsOutputVoltage=upsOutputVoltage, upsInputTransfer=upsInputTransfer, upsOutputFrequency=upsOutputFrequency, upsInfoMfrDate=upsInfoMfrDate, upsDriverName=upsDriverName, upsDriverProductID=upsDriverProductID, upsInfo=upsInfo, upsOutputFrequencyValue=upsOutputFrequencyValue, upsAmbient=upsAmbient, upsInfoLoad=upsInfoLoad, upsInputTransferLow=upsInputTransferLow, upsBatteryRuntimeValue=upsBatteryRuntimeValue, upsInfoAlarm=upsInfoAlarm, upsInfoStartBattery=upsInfoStartBattery, upsDeviceModel=upsDeviceModel, upsInfoStatus=upsInfoStatus, upsInputFrequencyHigh=upsInputFrequencyHigh, upsInfoContacts=upsInfoContacts, upsAmbientHumidityValue=upsAmbientHumidityValue, upsInputFrequencyValue=upsInputFrequencyValue, upsInfoMfrName=upsInfoMfrName, upsInfoMfr=upsInfoMfr, upsInfoBeeperStatus=upsInfoBeeperStatus, upsInfoFirmwareName=upsInfoFirmwareName, upsDriverPollFrequency=upsDriverPollFrequency, upsInputVoltageMax=upsInputVoltageMax, upsBatteryChargeLow=upsBatteryChargeLow, upsBatteryRuntime=upsBatteryRuntime, upsBatteryCharge=upsBatteryCharge, upsAmbientTemperatureLow=upsAmbientTemperatureLow, upsDriver=upsDriver, upsDriverSnmpVersion=upsDriverSnmpVersion, upsServer=upsServer, upsBatteryCurrent=upsBatteryCurrent, upsBatteryRuntimeRestart=upsBatteryRuntimeRestart, upsInfoPowerNominal=upsInfoPowerNominal, upsBatteryRuntimeLow=upsBatteryRuntimeLow, upsInputVoltageMin=upsInputVoltageMin, upsInputFrequencyExtend=upsInputFrequencyExtend, upsInfoFirmware=upsInfoFirmware, upsAmbientTemperatureAlarm=upsAmbientTemperatureAlarm, upsInputTransferHighMax=upsInputTransferHighMax, upsGroups=upsGroups, upsInputTransferBoostHigh=upsInputTransferBoostHigh, upsInputFrequencyNominal=upsInputFrequencyNominal, upsInfoStartReboot=upsInfoStartReboot, upsBatteryPacksBad=upsBatteryPacksBad, upsAmbientHumidity=upsAmbientHumidity, upsAmbientHumidityMax=upsAmbientHumidityMax, upsInfoTimerReboot=upsInfoTimerReboot, upsDriverPort=upsDriverPort, upsDeviceDescription=upsDeviceDescription, upsInfoDelayStart=upsInfoDelayStart, upsInfoRealPower=upsInfoRealPower, upsInputFrequency=upsInputFrequency, upsInfoPowerValue=upsInfoPowerValue, upsServerInfo=upsServerInfo, upsBatteryDate=upsBatteryDate, NonNegativeInteger=NonNegativeInteger, upsBatteryVoltageHigh=upsBatteryVoltageHigh, upsBatteryCapacity=upsBatteryCapacity, upsBatteryEnergySave=upsBatteryEnergySave, upsInputFrequencyLow=upsInputFrequencyLow, upsOutputVoltageNominal=upsOutputVoltageNominal, upsCompliance=upsCompliance, upsInfoVendorID=upsInfoVendorID, upsBatteryProtection=upsBatteryProtection, upsInputVoltageNominal=upsInputVoltageNominal, upsInfoFirmwareAux=upsInfoFirmwareAux, upsBatteryVoltageNominal=upsBatteryVoltageNominal, upsDeviceMACAddr=upsDeviceMACAddr, upsAmbientTemperature=upsAmbientTemperature, upsBatteryPacks=upsBatteryPacks, upsInputTransferHigh=upsInputTransferHigh, upsInfoDelayReboot=upsInfoDelayReboot, upsDeviceLocation=upsDeviceLocation, upsAmbientHumidityMin=upsAmbientHumidityMin, upsInfoProductID=upsInfoProductID, upsAmbientTemperatureMin=upsAmbientTemperatureMin, upsOutputCurrent=upsOutputCurrent, upsInfoID=upsInfoID, upsInputCurrentValue=upsInputCurrentValue, upsAmbientHumidityHigh=upsAmbientHumidityHigh, upsInfoStart=upsInfoStart, upsGroup=upsGroup, upsAmbientTemperatureHigh=upsAmbientTemperatureHigh, upsAmbientHumidityLow=upsAmbientHumidityLow, upsDevicePart=upsDevicePart, upsInfoTimerStart=upsInfoTimerStart, upsOutputFrequencyNominal=upsOutputFrequencyNominal, upsInputVoltageFault=upsInputVoltageFault, upsOutputCurrentNominal=upsOutputCurrentNominal, upsInfoDate=upsInfoDate, upsBatteryTemperature=upsBatteryTemperature, upsInputSensitivity=upsInputSensitivity, upsInfoSerial=upsInfoSerial, upsInputCurrentNominal=upsInputCurrentNominal, upsCompliances=upsCompliances, upsAmbientHumidityAlarm=upsAmbientHumidityAlarm, upsDriverVersion=upsDriverVersion)
