...
# ASN.1 source file:///Users/michal/.snmp/mibs/Q-BRIDGE-MIB
...
if mibBuilder.loadTexts: qBridgeMIB.setOrganization('HP')
...
qBridgePortGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 17, 7, 2, 1, 8)).setObjects(("Q-BRIDGE-MIB", "dot1qPvid"), ("Q-BRIDGE-MIB", "dot1qPortAcceptableFrameTypes"), ("Q-BRIDGE-MIB", "dot1qPortIngressFiltering"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
...
mibBuilder.exportSymbols("Q-BRIDGE-MIB", dot1qFdbTable=dot1qFdbTable, dot1qVlanForbiddenEgressPorts=dot1qVlanForbiddenEgressPorts, dot1qPvid=dot1qPvid, dot1qVlanVersionNumber=dot1qVlanVersionNumber, dot1qForwardAllPorts=dot1qForwardAllPorts, dot1qForwardAllEntry=dot1qForwardAllEntry, dot1qVlanStatus=dot1qVlanStatus, dot1qStaticMulticastEntry=dot1qStaticMulticastEntry, dot1qTpFdbTable=dot1qTpFdbTable, qBridgePortGroup=qBridgePortGroup, dot1qLearningConstraintsEntry=dot1qLearningConstraintsEntry, dot1qTpVlanPortInFrames=dot1qTpVlanPortInFrames, dot1qStaticUnicastAllowedToGoTo=dot1qStaticUnicastAllowedToGoTo, qBridgeLearningConstraintDefaultGroup=qBridgeLearningConstraintDefaultGroup, dot1qConstraintStatus=dot1qConstraintStatus, PortList=PortList, dot1qTpFdbPort=dot1qTpFdbPort, dot1qStaticUnicastReceivePort=dot1qStaticUnicastReceivePort, dot1qTpFdbAddress=dot1qTpFdbAddress, dot1qVlanCurrentEntry=dot1qVlanCurrentEntry, dot1qStaticUnicastTable=dot1qStaticUnicastTable, TimeFilter=TimeFilter, dot1qForwardUnregisteredStaticPorts=dot1qForwardUnregisteredStaticPorts, dot1qPortVlanStatisticsEntry=dot1qPortVlanStatisticsEntry, dot1qVlanStaticTable=dot1qVlanStaticTable, dot1qTpVlanPortHCInDiscards=dot1qTpVlanPortHCInDiscards, dot1qTpGroupEgressPorts=dot1qTpGroupEgressPorts, qBridgeFdbUnicastGroup=qBridgeFdbUnicastGroup, dot1qStaticUnicastEntry=dot1qStaticUnicastEntry, dot1qTpVlanPortHCOutFrames=dot1qTpVlanPortHCOutFrames, dot1qForwardUnregisteredTable=dot1qForwardUnregisteredTable, dot1qTpVlanPortOutOverflowFrames=dot1qTpVlanPortOutOverflowFrames, dot1qConstraintSetDefault=dot1qConstraintSetDefault, qBridgeGroups=qBridgeGroups, dot1qTpGroupAddress=dot1qTpGroupAddress, dot1qVlanCurrentTable=dot1qVlanCurrentTable, dot1qPortVlanHCStatisticsEntry=dot1qPortVlanHCStatisticsEntry, dot1qPortVlanHCStatisticsTable=dot1qPortVlanHCStatisticsTable, dot1qForwardUnregisteredPorts=dot1qForwardUnregisteredPorts, dot1qStaticMulticastTable=dot1qStaticMulticastTable, dot1qTpGroupEntry=dot1qTpGroupEntry, dot1qNumVlans=dot1qNumVlans, dot1qStaticUnicastAddress=dot1qStaticUnicastAddress, dot1qVlanNumDeletes=dot1qVlanNumDeletes, dot1qStatic=dot1qStatic, dot1qConstraintTypeDefault=dot1qConstraintTypeDefault, qBridgeVlanHCStatisticsGroup=qBridgeVlanHCStatisticsGroup, dot1qPortVlanStatisticsTable=dot1qPortVlanStatisticsTable, dot1qStaticMulticastStaticEgressPorts=dot1qStaticMulticastStaticEgressPorts, dot1qTpVlanPortInOverflowDiscards=dot1qTpVlanPortInOverflowDiscards, SnmpAdminString=SnmpAdminString, VlanId=VlanId, VlanIdOrNone=VlanIdOrNone, dot1qVlanTimeMark=dot1qVlanTimeMark, dot1qFdbDynamicCount=dot1qFdbDynamicCount, dot1qPortIngressFiltering=dot1qPortIngressFiltering, PYSNMP_MODULE_ID=qBridgeMIB, dot1qVlanStaticEgressPorts=dot1qVlanStaticEgressPorts, qBridgeMIBObjects=qBridgeMIBObjects, dot1qConstraintSet=dot1qConstraintSet, dot1qForwardUnregisteredForbiddenPorts=dot1qForwardUnregisteredForbiddenPorts, qBridgeVlanStatisticsOverflowGroup=qBridgeVlanStatisticsOverflowGroup, dot1qConstraintType=dot1qConstraintType, qBridgeServiceRequirementsGroup=qBridgeServiceRequirementsGroup, qBridgeVlanStaticGroup=qBridgeVlanStaticGroup, qBridgeVlanStatisticsGroup=qBridgeVlanStatisticsGroup, qBridgeVlanGroup=qBridgeVlanGroup, qBridgeMIB=qBridgeMIB, dot1qPortAcceptableFrameTypes=dot1qPortAcceptableFrameTypes, dot1qVlanCurrentUntaggedPorts=dot1qVlanCurrentUntaggedPorts, dot1qConstraintVlan=dot1qConstraintVlan, dot1qForwardAllTable=dot1qForwardAllTable, dot1qStaticMulticastReceivePort=dot1qStaticMulticastReceivePort, dot1qTpGroupTable=dot1qTpGroupTable, qBridgeCompliance=qBridgeCompliance, dot1qTpFdbStatus=dot1qTpFdbStatus, dot1qForwardAllStaticPorts=dot1qForwardAllStaticPorts, qBridgeConformance=qBridgeConformance, dot1qGvrpStatus=dot1qGvrpStatus, dot1qTpVlanPortInDiscards=dot1qTpVlanPortInDiscards, dot1qMaxVlanId=dot1qMaxVlanId, dot1qVlanCreationTime=dot1qVlanCreationTime, qBridgeLearningConstraintsGroup=qBridgeLearningConstraintsGroup, dot1qTpFdbEntry=dot1qTpFdbEntry, dot1qStaticUnicastStatus=dot1qStaticUnicastStatus, dot1qStaticMulticastStatus=dot1qStaticMulticastStatus, dot1qPortVlanTable=dot1qPortVlanTable, dot1qTpGroupLearnt=dot1qTpGroupLearnt, dot1qStaticMulticastForbiddenEgressPorts=dot1qStaticMulticastForbiddenEgressPorts, dot1qLearningConstraintsTable=dot1qLearningConstraintsTable, dot1qTpVlanPortOutFrames=dot1qTpVlanPortOutFrames, qBridgeFdbMulticastGroup=qBridgeFdbMulticastGroup, dot1qVlanStaticRowStatus=dot1qVlanStaticRowStatus, dot1qBase=dot1qBase, dot1qVlanCurrentEgressPorts=dot1qVlanCurrentEgressPorts, dot1qFdbEntry=dot1qFdbEntry, dot1qTpVlanPortHCInFrames=dot1qTpVlanPortHCInFrames, qBridgeBaseGroup=qBridgeBaseGroup, dot1qVlanFdbId=dot1qVlanFdbId, dot1qForwardAllForbiddenPorts=dot1qForwardAllForbiddenPorts, dot1qMaxSupportedVlans=dot1qMaxSupportedVlans, qBridgeCompliances=qBridgeCompliances, dot1qStaticMulticastAddress=dot1qStaticMulticastAddress, dot1qVlanStaticName=dot1qVlanStaticName, dot1qVlanStaticEntry=dot1qVlanStaticEntry, dot1qPortVlanEntry=dot1qPortVlanEntry, dot1qNextFreeLocalVlanIndex=dot1qNextFreeLocalVlanIndex, dot1qForwardUnregisteredEntry=dot1qForwardUnregisteredEntry, dot1qTpVlanPortInOverflowFrames=dot1qTpVlanPortInOverflowFrames, VlanIndex=VlanIndex, qBridgeFdbStaticGroup=qBridgeFdbStaticGroup, dot1qFdbId=dot1qFdbId, dot1qTp=dot1qTp, dot1qVlanStaticUntaggedPorts=dot1qVlanStaticUntaggedPorts, dot1qVlan=dot1qVlan, dot1qVlanIndex=dot1qVlanIndex)
