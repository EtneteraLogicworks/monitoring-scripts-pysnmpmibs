...
# ASN.1 source file:///Users/michal/.snmp/mibs/EdgeSwitch-BOXSERVICES-PRIVATE-MIB
...
Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Counter64, TimeTicks, ObjectIdentity, MibIdentifier, Bits, NotificationType, Integer32, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Counter64", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Bits", "NotificationType", "Integer32", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("EdgeSwitch-BOXSERVICES-PRIVATE-MIB", boxServicesTempUnitTemperature=boxServicesTempUnitTemperature, boxsTemperatureStatusPreviousEvent=boxsTemperatureStatusPreviousEvent, boxServicesTempUnitEntry=boxServicesTempUnitEntry, boxsItemStateChangeEvent=boxsItemStateChangeEvent, boxServicesTemperatureTrapEnable=boxServicesTemperatureTrapEnable, boxServicesFanStateTrapEnable=boxServicesFanStateTrapEnable, boxsLocatorLedEnable=boxsLocatorLedEnable, boxServicesFansEntry=boxServicesFansEntry, boxsLocatorLedUnit=boxsLocatorLedUnit, boxServicesPowSuppliesTable=boxServicesPowSuppliesTable, boxServicesPowSupplyItemState=boxServicesPowSupplyItemState, boxServicesThermalShutdownSensor=boxServicesThermalShutdownSensor, boxServicesFanItemType=boxServicesFanItemType, boxServicesTempSensorIndex=boxServicesTempSensorIndex, boxServicesFanSpeed=boxServicesFanSpeed, BoxsTemperatureStatus=BoxsTemperatureStatus, boxServicesTempUnitTable=boxServicesTempUnitTable, boxServicesUnitIndex=boxServicesUnitIndex, boxServicesFanItemState=boxServicesFanItemState, boxServicesTempSensorType=boxServicesTempSensorType, boxServicesNotificationsGroup=boxServicesNotificationsGroup, boxServicesNormalTempRangeMax=boxServicesNormalTempRangeMax, boxsPowSupplyStateChange=boxsPowSupplyStateChange, boxServicesTempSensorsEntry=boxServicesTempSensorsEntry, boxServicesFansTable=boxServicesFansTable, boxServicesFanDutyLevel=boxServicesFanDutyLevel, boxServicesFanUnitIndex=boxServicesFanUnitIndex, fastPathBoxServices=fastPathBoxServices, boxServicesTempSensorTemperature=boxServicesTempSensorTemperature, boxServicesGroup=boxServicesGroup, boxServicesPowSupplyIndex=boxServicesPowSupplyIndex, boxServicesNormalTempRangeMin=boxServicesNormalTempRangeMin, boxServicesTempSensorState=boxServicesTempSensorState, boxServicesPowSuppliesEntry=boxServicesPowSuppliesEntry, boxServicesTempUnitState=boxServicesTempUnitState, boxServicesTempSensorsTable=boxServicesTempSensorsTable, boxsTemperatureChange=boxsTemperatureChange, boxServicesPowSupplyItemType=boxServicesPowSupplyItemType, boxServicesFansIndex=boxServicesFansIndex, fastPathBoxServicesTraps=fastPathBoxServicesTraps, boxsTemperatureChangeEvent=boxsTemperatureChangeEvent, PYSNMP_MODULE_ID=fastPathBoxServices, boxsLocatorLedConfigGroup=boxsLocatorLedConfigGroup, boxsThermalShutdown=boxsThermalShutdown, boxsTemperatureStatusCurrentEvent=boxsTemperatureStatusCurrentEvent, boxServicesTempUnitIndex=boxServicesTempUnitIndex, boxsFanStateChange=boxsFanStateChange, boxServicesPSMStateTrapEnable=boxServicesPSMStateTrapEnable, boxsLocatorLedTime=boxsLocatorLedTime, boxsTemperatureStateChange=boxsTemperatureStateChange, boxServicesPowerSuppUnitIndex=boxServicesPowerSuppUnitIndex, boxServicesThermalShutdownTemperature=boxServicesThermalShutdownTemperature)
