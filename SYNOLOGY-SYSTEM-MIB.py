...
# ASN.1 source file:///Users/michal/.snmp/mibs/SYNOLOGY-SYSTEM-MIB
...
mibBuilder.exportSymbols("SYNOLOGY-SYSTEM-MIB", systemConformance=systemConformance, PYSNMP_MODULE_ID=synoSystem, serialNumber=serialNumber, systemGroups=systemGroups, systemCompliances=systemCompliances, version=version, synology=synology, systemCompliance=systemCompliance, dsmInfo=dsmInfo, fan=fan, systemStatus=systemStatus, powerStatus=powerStatus, systemGroup=systemGroup, temperature=temperature, modelName=modelName, upgradeAvailable=upgradeAvailable, cpuFanStatus=cpuFanStatus, synoSystem=synoSystem, systemFanStatus=systemFanStatus)
