...
# ASN.1 source file:///Users/michal/.snmp/mibs/NAS-MIB
# Produced by pysmi-0.3.4 at Wed Sep  9 17:56:47 2020
# On host LogicAir.local platform Darwin version 19.6.0 by user michal
# Using Python version 3.7.3 (default, Aug  4 2020, 19:30:55) 
#
ObjectIdentifier, Integer, OctetString = mibBuilder.importSymbols("ASN1", "ObjectIdentifier", "Integer", "OctetString")
NamedValues, = mibBuilder.importSymbols("ASN1-ENUMERATION", "NamedValues")
ConstraintsIntersection, ValueSizeConstraint, SingleValueConstraint, ValueRangeConstraint, ConstraintsUnion = mibBuilder.importSymbols("ASN1-REFINEMENT", "ConstraintsIntersection", "ValueSizeConstraint", "SingleValueConstraint", "ValueRangeConstraint", "ConstraintsUnion")
NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance")
NotificationType, Bits, Gauge32, ObjectIdentity, Integer32, NotificationType, IpAddress, enterprises, Counter64, TimeTicks, Unsigned32, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "Gauge32", "ObjectIdentity", "Integer32", "NotificationType", "IpAddress", "enterprises", "Counter64", "TimeTicks", "Unsigned32", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("NAS-MIB", raidFreeSize=raidFreeSize, volumeStatus=volumeStatus, ifEntryEx=ifEntryEx, target=target, systemPower=systemPower, targetIndex=targetIndex, systemUptime=systemUptime, sysVolumeFreeSize=sysVolumeFreeSize, cpu_TemperatureEX=cpu_TemperatureEX, systemFanID=systemFanID, ifDescr=ifDescr, systemTraps=systemTraps, systemFan=systemFan, hdCapacity=hdCapacity, sysFanSpeed=sysFanSpeed, hdTemperature=hdTemperature, eventError=eventError, enclosureModel=enclosureModel, modelName=modelName, targetStatus=targetStatus, ifNumberEX=ifNumberEX, diskNumber=diskNumber, volumeSSDCache=volumeSSDCache, hdDescrEX=hdDescrEX, sysVolumeDescrEX=sysVolumeDescrEX, msataDiskID=msataDiskID, systemVolumeTable=systemVolumeTable, poolTable=poolTable, systemVolumeTableEx=systemVolumeTableEx, sysVolumeFSEX=sysVolumeFSEX, service=service, sysVolumeTotalSizeEX=sysVolumeTotalSizeEX, msataDisk=msataDisk, enclosureName=enclosureName, iSNSService=iSNSService, sysFanEntryEx=sysFanEntryEx, raidCapacity=raidCapacity, sysFanIndexEX=sysFanIndexEX, modelNameEX=modelNameEX, components=components, diskTemperture=diskTemperture, lunStatus=lunStatus, targetID=targetID, diskGlobalSpare=diskGlobalSpare, availablePercent=availablePercent, cpu_Temperature=cpu_Temperature, storageSystem=storageSystem, msataDiskGlobalSpare=msataDiskGlobalSpare, diskID=diskID, systemFreeMem=systemFreeMem, enclosureID=enclosureID, lunIsMap=lunIsMap, ifPacketsReceivedEX=ifPacketsReceivedEX, raidGroupTableEntry=raidGroupTableEntry, readHitRate=readHitRate, diskTableEntry=diskTableEntry, hdModel=hdModel, lunID=lunID, msataDiskEnclosureID=msataDiskEnclosureID, ifErrorPackets=ifErrorPackets, storageSpace=storageSpace, systemCPU_Usage=systemCPU_Usage, systemTemperature=systemTemperature, poolTableEntry=poolTableEntry, cpuID=cpuID, enclosureSlot=enclosureSlot, systemUptimeEX=systemUptimeEX, systemFanTable=systemFanTable, hdNumber=hdNumber, hostNameEX=hostNameEX, pool=pool, systemHdTable=systemHdTable, diskPerformance=diskPerformance, msataDiskNumber=msataDiskNumber, systemTotalMemEX=systemTotalMemEX, sysFanSpeedEX=sysFanSpeedEX, raidGroupTable=raidGroupTable, lunCapacity=lunCapacity, iSCSIServicePort=iSCSIServicePort, systemFanEnclosureID=systemFanEnclosureID, eventWarningMsg=eventWarningMsg, systemInfo=systemInfo, ifPacketsSent=ifPacketsSent, volumeTable=volumeTable, raidID=raidID, lun=lun, raidLevel=raidLevel, lunIndex=lunIndex, targetIQN=targetIQN, enclosure=enclosure, writeHitRate=writeHitRate, disk=disk, msataDiskTableEntry=msataDiskTableEntry, msataDiskTemperture=msataDiskTemperture, systemFanIndex=systemFanIndex, iops=iops, systemTotalMem=systemTotalMem, systemPowerID=systemPowerID, sysVolumeDescr=sysVolumeDescr, sysVolumeIndex=sysVolumeIndex, lunTableEntry=lunTableEntry, sysFanNumber=sysFanNumber, ifErrorPacketsEX=ifErrorPacketsEX, iSCSIStorage=iSCSIStorage, diskSummary=diskSummary, enclosureSerialNum=enclosureSerialNum, blvID=blvID, hdStatus=hdStatus, poolIndex=poolIndex, sysVolumeStatus=sysVolumeStatus, systemIfTable=systemIfTable, sysVolumeTotalSize=sysVolumeTotalSize, volumeThin=volumeThin, sysFanNumberEX=sysFanNumberEX, diskTable=diskTable, poolStatus=poolStatus, hdNumberEX=hdNumberEX, hdEntryEx=hdEntryEx, lunName=lunName, cpuIndex=cpuIndex, ifPacketsSentEX=ifPacketsSentEX, systemFanSpeed=systemFanSpeed, sysVolumeIndexEX=sysVolumeIndexEX, lunUsedPercent=lunUsedPercent, sysVolumeStatusEX=sysVolumeStatusEX, enclosureTable=enclosureTable, systemFan2TableEntry=systemFan2TableEntry, cpuNumber=cpuNumber, eventInformMsg=eventInformMsg, hdDescr=hdDescr, ifIndex=ifIndex, hdSmartInfoEX=hdSmartInfoEX, diskIndex=diskIndex, cpuTableEntry=cpuTableEntry, hdIndexEX=hdIndexEX, cacheAcceleration=cacheAcceleration, hdModelEX=hdModelEX, systemPowerTableEntry=systemPowerTableEntry, systemFanStatus=systemFanStatus, diskCapacity=diskCapacity, lunNumber=lunNumber, lunBackupStatus=lunBackupStatus, systemPowerFanSpeed=systemPowerFanSpeed, systemPowerIndex=systemPowerIndex, diskPerformanceTableEntry=diskPerformanceTableEntry, systemCPU_UsageEX=systemCPU_UsageEX, hostName=hostName, poolFreeSize=poolFreeSize, systemPowerTemp=systemPowerTemp, systemHdTableEX=systemHdTableEX, volumeName=volumeName, msataDiskModel=msataDiskModel, resourceMonitor=resourceMonitor, cpuTable=cpuTable, systemFanTableEx=systemFanTableEx, hdSmartInfo=hdSmartInfo, enclosurelNumber=enclosurelNumber, poolNumber=poolNumber, msataDiskTable=msataDiskTable, targetNumber=targetNumber, volumeID=volumeID, status=status, systemFan2Table=systemFan2Table, sysVolumeFreeSizeEX=sysVolumeFreeSizeEX, poolCapacity=poolCapacity, hdStatusEX=hdStatusEX, raidNumber=raidNumber, ifIndexEX=ifIndexEX, eventInform=eventInform, volumeFreeSize=volumeFreeSize, diskPerformanceIndex=diskPerformanceIndex, hdEntry=hdEntry, eventErrorMsg=eventErrorMsg, diskEnclosureID=diskEnclosureID, diskPerformanceNumber=diskPerformanceNumber, volumeIndex=volumeIndex, diskPerformanceTable=diskPerformanceTable, sysVolumeEntry=sysVolumeEntry, storageManager=storageManager, msataDiskSummary=msataDiskSummary, targeTable=targeTable, systemTemperatureEX=systemTemperatureEX, msataDiskCapacity=msataDiskCapacity, hdIndex=hdIndex, iSCSIService=iSCSIService, ifDescrEX=ifDescrEX, systemStatus=systemStatus, nasStorage=nasStorage, raid=raid, cpuTemp=cpuTemp, ifPacketsReceived=ifPacketsReceived, storage=storage, raidBitmap=raidBitmap, systemIfTableEx=systemIfTableEx, hdTemperatureEX=hdTemperatureEX, systemInfoEx=systemInfoEx, volumeCapacity=volumeCapacity, sysVolumeNumber=sysVolumeNumber, sysFanEntry=sysFanEntry, raidIndex=raidIndex, cpuUsage=cpuUsage, DisplayString=DisplayString, targetName=targetName, poolID=poolID, diskSmartInfo=diskSmartInfo, storageSystemEx=storageSystemEx, msataDiskSmartInfo=msataDiskSmartInfo, cpu=cpu, systemPowerNumber=systemPowerNumber, sysFanDescr=sysFanDescr, targeTableEntry=targeTableEntry, sysVolumeFS=sysVolumeFS, raidStatus=raidStatus, systemFreeMemEX=systemFreeMemEX, sysFanDescrEX=sysFanDescrEX, sysVolumeEntryEx=sysVolumeEntryEx, volumeNumber=volumeNumber, systemFanNumber=systemFanNumber, ifNumber=ifNumber, enclosureIndex=enclosureIndex, msataDiskIndex=msataDiskIndex, sysVolumeNumberEX=sysVolumeNumberEX, ifEntry=ifEntry, sysFanIndex=sysFanIndex, systemEventMsg=systemEventMsg, iSNSIP=iSNSIP, diskModel=diskModel, systemPowerStatus=systemPowerStatus, latency=latency, hdCapacityEX=hdCapacityEX, systemPowerTable=systemPowerTable, systemSettings=systemSettings, volume=volume, lunTable=lunTable, iSCSI=iSCSI, systemPowerEnclosureID=systemPowerEnclosureID, enclosureTableEntry=enclosureTableEntry, enclosureSystemTemp=enclosureSystemTemp, eventWarning=eventWarning, volumeTableEntry=volumeTableEntry)
